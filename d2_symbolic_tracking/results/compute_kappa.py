"""compute_kappa.py  Usage: python compute_kappa.py parser_validation_<ID>.json"""
# -*- coding: utf-8 -*-
import json, sys
...
if k>=0.80:   print("PASS: kappa>=0.80 +- TFBC metric defensible")
elif k>=0.60: print("BORDERLINE: revise parser before submission")
